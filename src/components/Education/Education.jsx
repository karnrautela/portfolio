...
import { educaton } from "../../constants.js";

const Education = () => {
  return (
    <section
      id="education"
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans bg-skill-gradient clip-path-custom-3"
    >
      ...
      <div className="relative">
        ...
        {educaton.map((edu, index) => (
          ...
          >
            {/* timeline circle */}
            <div className="sm:hidden md:block absolute sm:left-1/2 left-0 transform">
              <img
                src={edu.img}
                alt={edu.school}
            ...
            >
              ...
              <div className="  flex items-center space-x-6">
                ...
                <div className="flex flex-col justify-between ">
                  <div>
                    <h3 className="text-xl sm:2xl font-semibold text-white">
                      {edu.degree}
                    </h3>
                    <h4 className="text-md sm:tex-sm text-gray-300">
                      {edu.school}
                    </h4>
                  </div>
